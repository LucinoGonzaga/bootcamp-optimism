...
Para iniciar o container execute o comando
    ...
    docker-compose up --build aula2

Caso esteja tudo certo, será possível acessar a pagina através do endereço abaixo através de um navegador:

http://localhost:3330/

## 2. Instalações
📦 Instalar Docker: [Instalação Node.js](https://nodejs.org/en/download/package-manager#debian-and-ubuntu-based-linux-distributions)
...
## 5. Dados (Functional Programming)
